      ...
      dimension rr(80000),om(80000),om2(80000),psi(80000),
     +                   ak(80000),ak2(80000)
      dimension psirr(80000)
      data ifirst /0/
      save ifirst, a, b
...
c        open(11,file='omekap.dat',status='new',err=23)
c        do ir=1,nreq
c          write(11,'(7g16.8)') rr(ir),om(ir),om2(ir),ak(ir),ak2(ir),
c     +                          psi(ir),psirr(ir)
c          enddo
c        do ir=1,10
c           rx=rr(nreq)*(1+0.1*ir)
c           r3=a/rx**3
c           r5=3*b/rx**5
c           fom=sqrt(r3+r5)
c           fka=sqrt(r3-r5)
c           write(11,'(7g16.8)') rx,fom,0.,fka,0.,
c     +                          c-(r3+r5/3.)*rx*rx,-2*r3-4*r5
c           enddo
c        close(11)
c        write(0,*) 'wrote a table of frequencies in file omekap.dat.'
 23     continue
        ifirst=1
      endif
